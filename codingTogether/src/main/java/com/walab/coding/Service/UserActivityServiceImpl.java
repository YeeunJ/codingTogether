...
import com.walab.coding.Repository.UserActivityDAO;
...
public class UserActivityServiceImpl implements UserActivityService{
	...
	@Autowired
	UserActivityDAO userActivityService ;//= new UserProblemDAO(dataSource);
...
//	}
	...
	public List<GoalDTO> readGoal(int userID){
		List<GoalDTO> goals = userActivityService.readGoalAll(userID);
